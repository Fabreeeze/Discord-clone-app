...
export const ChatItem = ({
    ...
    const onSubmit = async(values:z.infer<typeof formSchema>) => {
        try{
            ...
            // this patch query to edit our message
    ...
    // to render the previous text in the edit field when clicking on edit
    ...
    // fileurl being there indicates an attachment message
    // we cant edit an attachment, only delete it
